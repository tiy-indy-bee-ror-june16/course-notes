...
Before class starts, I also encourage you to review the [class_policies.md](class_policies.md) to everyone's expectations are aligned for the start of the course.
...
["How to Win The Iron Yard"](https://medium.com/@SchnettHappens/how-to-win-the-iron-yard-646cdc11f7a0) is a great compilation of advice for new Iron Yard students. Bonus: It's compiled by a recently-graduated Iron Yard student.
...
Past cohorts have really found [Ruby Wizardry](https://www.nostarch.com/rubywizardry), a book intended to introduce programming to children, really useful - especially for the first two weeks of the course.
